  ...
  if (Vser.available())
  {
    ...
    if (label == "PID") {
      ...
      switch (A) {
        ...
        case 0xA102 : client.publish("Victron/PID", "SmartSolar MPPT VE.Can 150/70");  break;
        case 0xA103 : client.publish("Victron/PID", "SmartSolar MPPT VE.Can 150/45");  break;
        case 0xA104 : client.publish("Victron/PID", "SmartSolar MPPT VE.Can 150/60");  break;
        case 0xA105 : client.publish("Victron/PID", "SmartSolar MPPT VE.Can 150/85");  break;
        case 0xA106 : client.publish("Victron/PID", "SmartSolar MPPT VE.Can 150/100");  break;
        case 0xA107 : client.publish("Victron/PID", "SmartSolar MPPT VE.Can 250/45");  break;
        case 0xA108 : client.publish("Victron/PID", "SmartSolar MPPT VE.Can 250/60");  break;
        case 0xA109 : client.publish("Victron/PID", "SmartSolar MPPT VE.Can 250/70");  break;
        case 0xA10A : client.publish("Victron/PID", "SmartSolar MPPT VE.Can 250/85");  break;
        case 0xA10B : client.publish("Victron/PID", "SmartSolar MPPT VE.Can 250/100");  break;
        case 0xA10C : client.publish("Victron/PID", "SmartSolar MPPT VE.Can 150/70 rev2");  break;
        case 0xA10D : client.publish("Victron/PID", "SmartSolar MPPT VE.Can 150/85 rev2");  break;
        case 0xA10E : client.publish("Victron/PID", "SmartSolar MPPT VE.Can 150/100 rev2");  break;
